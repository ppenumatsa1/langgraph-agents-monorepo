...
4. ToolNode executes web search to populate sources:
   - Tool node: [agents/researcher-agent/app/langgraph/nodes/web_search.py](agents/researcher-agent/app/langgraph/nodes/web_search.py)
